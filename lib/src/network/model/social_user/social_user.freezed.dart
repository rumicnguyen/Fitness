...
/// @nodoc
@JsonSerializable()
class _$MSocialUserImpl extends _MSocialUser {
  ...
  @override
  String toString() {
    return 'MSocialUser(type: $type, accessToken: $accessToken, idToken: $idToken, fullName: $fullName, email: $email, avatar: $avatar, birthDate: $birthDate, gender: $gender, phone: $phone)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, type, accessToken, idToken,
      fullName, email, avatar, birthDate, gender, phone);
...
abstract class _MSocialUser extends MSocialUser {
